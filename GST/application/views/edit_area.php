<?php include_once('templates/header.php');?>
    ...
    <div id="main-content">
        ...
        <div class="page-title">
            <div>
                <h1><i class="fa fa-file-o"></i> Update Area Details</h1>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <div class="box-title">
                        <h3><i class="fa fa-bars"></i> Area Details Update Panel</h3>
                    ...
                    <div class="box-content">
                        <form name="service_form" action="<?php echo base_url();?>index.php/Update/Area" method="post" enctype="multipart/form-data" class="form-horizontal" onsubmit="return validate_area();">
                           ...
                           <div class="form-group">
                                ...
                                <div class="col-sm-9 col-lg-10 controls">
                                    <input type="text" class="form-control show-popover" data-trigger="hover"
                                           ...
                                           data-original-title="Optional" data-placement="top" name="txt_landmark" id="txt_landmark" value="<?php echo $data[0]['landmark'];?>"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-lg-10 controls">
                                    <textarea class="form-control show-popover" rows="3" data-trigger="hover"
                                           ...
                                           data-original-title="Optional" data-placement="top" name="txt_address" id="txt_address"><?php echo $data[0]['address'];?></textarea>
                                </div>
                            </div>
                             <div class="form-group">
                                ...
                                <div class="col-sm-9 col-lg-10 controls">
                                    <input type="text" class="form-control show-popover" data-trigger="hover"
                                           ...
                                           data-original-title="Mandatory ***" data-placement="top" name="txt_client" id="txt_client" value="<?php echo $data[0]['c_name'];?>"/>
                                </div>
                            </div>
                             <div class="form-group">
                                ...
                                <div class="col-sm-9 col-lg-10 controls">
                                    <input type="text" class="form-control show-popover" data-trigger="hover"
                                           ...
                                           data-original-title="Mandatory ***" data-placement="top" name="txt_ag_per" id="txt_ag_per" value="<?php echo $data[0]['ag_p'];?>"/>
                                </div>
                            </div>
                             <div class="form-group">
                                ...
                                <div class="col-sm-9 col-lg-10 controls">
                                    <input type="text" class="form-control show-popover" data-trigger="hover"
                                           ...
                                           data-original-title="Mandatory ***" data-placement="top" name="txt_rent_amt" id="txt_rent_amt" value="<?php echo $data[0]['rent_amt'];?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-lg-10 controls">
                                    <textarea class="form-control show-popover" rows="3" data-trigger="hover"
                                           ...
                                           data-original-title="Optional" data-placement="top" name="txt_remarks" id="txt_remarks"><?php echo $data[0]['rmrks'];?></textarea>
                                </div>
                            </div>
