...
<table width="700" border="0" cellspacing="0" cellpadding="0">
  ...
  $Main_media_size211 = explode(',',$Corders['size']);
    ...
    <?php } } else echo $Corders['tot_amt_p'];?>        
          ...
          <tr>
            <td colspan="3" align="left" valign="middle" class="style4"><?php echo $Corders['main_media_title'];?><br/>(P.O. No. : <?php echo $Corders['po_no'];?>)</td>
            ...
            <td align="right" valign="top" class="style4"><?php $expt = explode(',',$expimplode); 
									...
									if($data[0]['tax_id'] != '') {for($j=$ck;$j<=$exp_cnt1;$j++) { $taxes = $this->db->query('SELECT SUM(tax5) as tttaxsc FROM td_order WHERE order_id IN ('.$data[0]['order_id'].')')->result_array();$tid = $j+1;?><?php echo $taxes[0]['tttaxsc'];?><br/><?php }} ?><br/><?php if($SumOChrg[0]['otherTotal'] != 0) echo $SumOChrg[0]['otherTotal'];?><br /></td>
          </tr>
          <tr>
            <td colspan="4">&nbsp;</td>
