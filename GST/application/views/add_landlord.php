<?php include_once('templates/header.php');?>
    ...
    <div id="main-content">
        ...
        <div class="page-title">
            <div>
                <h1><i class="fa fa-file-o"></i> Add New Land Lord</h1>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <div class="box-title">
                        <h3><i class="fa fa-bars"></i> Add New Land Lord</h3>
                    ...
                    <div class="box-content">
                        <form name="service_form" action="<?php echo base_url();?>index.php/Add/LandLord" method="post" enctype="multipart/form-data" class="form-horizontal" onsubmit="return validate_order();">
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-sm-9 col-lg-10 controls">
                                    <input type="text" class="form-control show-popover" data-trigger="hover"
                                           ...
                                           data-original-title="Optional" data-placement="top" name="txt_acq_for" id="txt_acq_for"/><br/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-lg-10 controls">
                                    <input type="text" class="form-control show-popover" data-trigger="hover"
                                           ...
                                           data-original-title="Optional" data-placement="top" name="txt_space_loc" id="txt_space_loc"/>
                                </div>
                            </div><br />
 <div class="form-group">
                                ...
                                <div class="col-sm-9 col-lg-10 controls">
                                    <input type="text" class="form-control show-popover" data-trigger="hover"
                                           ...
                                           data-original-title="Optional" data-placement="top" name="txt_tax_size" id="txt_tax_size"/>
                                </div>
                            </div>
                            <div class="form-group">
