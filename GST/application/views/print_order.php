<?php include_once('templates/header.php');?>
    ...
    <div id="main-content">
        ...
        <div class="page-title">
            <div>
                <h1><i class="fa fa-file-o"></i> Add New Print Order</h1>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <div class="box-title">
                        <h3><i class="fa fa-bars"></i> Add New Print Order</h3>
                    ...
                    <div class="box-content">
                        <form name="service_form" action="<?php echo base_url();?>index.php/Add/PrintOrderDetails" method="post" enctype="multipart/form-data" class="form-horizontal" onsubmit="return validate_Printorder();">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-lg-10 controls">
                                    <input type="text" class="form-control show-popover" data-trigger="hover"
                                           ...
                                           data-original-title="Optional" data-placement="top" name="txt_bill_date" id="datepicker3" onblur="return getinvoice()"/>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 col-lg-2 control-label">Select Sides</label>

                                <div class="col-sm-9 col-lg-10 controls">
                                 <input type="text" class="form-control show-popover" data-trigger="hover"
                                           data-content="Enter sides"
                                           data-original-title="Optional" data-placement="top" name="txt_media_side" id="txt_media_side"/>
                           ...
                           <div class="form-group">
                                ...
                                <div class="col-sm-9 col-lg-10 controls">
                                    <input type="text" class="form-control show-popover" data-trigger="hover"
                                           data-content="Enter Client Phone"
                                           data-original-title="Optional" data-placement="top" name="txt_quantity" id="txt_quantity"/>
                                </div>
                            </div>
                             </div>
                            <div id="package" style="display:none;">
                            <div class="form-group">
                                <label class="col-sm-3 col-lg-2 control-label">Total Square Fit</label>

                                <div class="col-sm-9 col-lg-10 controls">
                                    <input type="text" class="form-control show-popover" data-trigger="hover"
                                           data-content="Enter package space charge"
                                           data-original-title="Optional" data-placement="top" name="txt_sqr_fit" id="txt_sqr_fit"/>
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 col-lg-2 control-label">Price / sq. ft.</label>

                                <div class="col-sm-9 col-lg-10 controls">
                                    <input type="text" class="form-control show-popover" data-trigger="hover"
                                           data-content="Enter Client Phone"
                                           data-original-title="Optional" data-placement="top" name="txt_price" id="txt_price"/>
        ...
        <!-- END Main Content -->
        <input type="hidden" name="mediaType" id="mediaType" value="P" />
       ...
       function showData(tval) {
		   $('#mediaType').val(tval);
		    ...
		    function getinvoice() {
                    ...
                    jQuery.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>" + "index.php/Index/getInvoiceprint",
                        dataType: 'json',
                        data: {renttype: mtype, bday: bdate},
                        success: function(res) {
							var mtype1 = $('#mediaType').val();
							var bill = 'B/SYNS/GST/'+mtype+'/'+ +res;
							var Newbill = 'B/SYNS/GST/'+mtype+'/';
