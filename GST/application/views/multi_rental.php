    ...
    <td width="700" height="1000" align="center" valign="top"><table width="680" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td colspan="3" align="center" valign="middle" ><table width="670" border="1" cellpadding="4" cellspacing="0" bordercolor="#000000" style="border-collapse:collapse;">
          <tr>
            <td width="315"><span class="style12">Location</span></td>
            <td width="40"><span class="style12">Size</span></td>
            <td width="23"><span class="style12">Qty</span></td>
            <td width="61"><span class="style12">Space Chrg </span></td>
            <td width="112"><span class="style12">Period</span></td>
            <td width="57"><span class="style12">Amount (INR)</span></td>
          </tr>
          <tr>
...
if($Corders['package_type'] == 2){
  $Main_media_size2 = explode(',',$Corders['size']);
    ...
    $msize = $this->db->query("SELECT * FROM td_size WHERE size_id =".$Main_media_size2[$sz])->result_array();
            ...
            <td align="left" valign="top" class="style4"><br />
             <?php if($Corders['package_type'] == 2){?>
             <?php for($rm=0;$rm<=$expPCountmnth;$rm++) { ?>
              <?php echo $exppqtymnth[$rm];?> p.m<br />
              <?php } } else { echo $Corders['space_chrge'];}?>
             </td>
            <td align="left" valign="top" class="style4"><br />
          ...
          <tr>
            ...
            <td align="right" valign="top" class="style4"><?php $expt = explode(',',$expimplode); 
									$exp_cnt = count($expt);
									if($data[0]['tax_id'] != '') {for($i=1;$i<=$exp_cnt;$i++) { $taxes = $this->db->query('SELECT SUM(tax'.$i.') as tttaxsc FROM td_order WHERE order_id IN ('.$timpid.')')->result_array();$tid = $i+1;?><?php echo round($taxes[0]['tttaxsc'],1);?><br/><?php }} ?><br/><?php if($SumOChrg[0]['otherTotal'] != 0) echo $SumOChrg[0]['otherTotal'];?></td>
          </tr>
          <tr>
            <td colspan="4">&nbsp;</td>
      ...
      <tr>
        ...
        <td height="43" align="right" valign="bottom">&nbsp;</td>
        <td height="43" align="right" valign="bottom" class="style12">For Bells Advertising Syndicates</td>
      </tr>
    </table></td>
  </tr>
</table>
