<?php include_once('templates/header.php');?>
   ...
   <div id="main-content">
        ...
        <div class="page-title">
            <div>
                <h1><i class="fa fa-file-o"></i>Client Order List</h1>
        ...
        <div id="breadcrumbs">
            <ul class="breadcrumb">
                ...
                <li class="active">Client Order List</li>
            </ul>
        </div>
        <!-- END Breadcrumb -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <div class="box-title">
                        <h3><i class="fa fa-table"></i> Client Order List</h3>
                        ...
                        <div class="table-responsive" style="border:0">
                            <table class="table table-advance" id="table1">
								...
								?>
                                    ...
                                    <td><?php if($values['tax_id'] != '') {for($i=0;$i<=$exp_cnt;$i++) { $taxes = $this->db->query('SELECT * FROM td_service_charge WHERE sc_id='.$expt[$i])->result_array();$tid = $i+1;?><?php echo $taxes[0]['charge_name'];?><br/>(<?php echo $values['tax'.$tid];?>)<hr style="border-top:1px solid #000;"><?php }}?></td>
                                    <td><?php echo $values['other_charge'];?></td>
                                    <td><?php echo $values['chrge_amt'];?></td>
                                    <td><a href="<?php echo base_url();?>index.php/Edit/Client/<?php echo $values['order_id'];?>"><button class="btn btn-circle btn-bordered btn-lime show-popover" data-trigger="hover" data-content="Edit This Content" data-original-title="Admin Action" data-placement="top"><i class="fa fa-edit"></i></button></a>&nbsp;&nbsp;<a href="<?php echo base_url();?>index.php/Delete/Client/<?php echo $values['order_id'];?>"><button class="btn btn-circle btn-bordered btn-warning btn-to-gray show-popover" data-trigger="hover" data-content="Delete This Content" data-original-title="Admin Action" data-placement="top"><i class="fa fa-trash-o"></i></button></a>
