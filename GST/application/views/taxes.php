<?php include_once('templates/header.php');?>
    ...
    <div id="main-content">
        ...
        <div class="page-title">
            <div>
                <h1><i class="fa fa-file-o"></i> Add Service Charges</h1>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <div class="box-title">
                        <h3><i class="fa fa-bars"></i> Service Charges Entry Panel</h3>
                    ...
                    <div class="box-content">
                        <form name="service_form" action="<?php echo base_url();?>index.php/Add/ServiceCharge" method="post" enctype="multipart/form-data" class="form-horizontal" onsubmit="return validate_taxes();">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control show-popover" data-trigger="hover"
                                           ...
                                           data-original-title="Mandatory ***" data-placement="top" name="txt_percent" id="txt_percent" /> &nbsp;(e.g. 0.5. This will be calculated as % of main amount)
