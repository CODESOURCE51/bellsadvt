<?php include_once('templates/header.php');?>
    ...
    <div id="main-content">
        ...
        <div class="page-title">
            <div>
                <h1><i class="fa fa-file-o"></i> Update Land Lord</h1>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <div class="box-title">
                        <h3><i class="fa fa-bars"></i> Update Land Lord</h3>
                    ...
                    <div class="box-content">
                        <form name="service_form" action="<?php echo base_url();?>index.php/Update/LandLord" method="post" enctype="multipart/form-data" class="form-horizontal" onsubmit="return validate_order();">
                           <input type="hidden" name="cid" value="<?php echo $data[0]['land_id'];?>" />
                             <div class="form-group">
                                <label class="col-sm-3 col-lg-2 control-label">Acquired For</label>

                                <div class="col-sm-9 col-lg-10 controls">
                                    <input type="text" class="form-control show-popover" data-trigger="hover"
                                           data-content="Enter Reason"
                                           data-original-title="Optional" data-placement="top" name="txt_acq_for" id="txt_acq_for" value="<?php echo $data[0]['acq_for'];?>"/><br/>
                                           (e.g : Hording,Pol Kiosk)
                                </div>
                            </div>
                             <div class="form-group">
                                ...
                                <div class="col-sm-9 col-lg-10 controls">
                                    <input type="text" class="form-control show-popover" data-trigger="hover"
                                           ...
                                           data-original-title="Optional" data-placement="top" name="txt_space_lord" id="txt_space_lord" value="<?php echo $data[0]['sp_lord'];?>"/>
                                </div>
                            </div>
                             <div class="form-group">
                                ...
                                <div class="col-sm-9 col-lg-10 controls">
                                    <input type="text" class="form-control show-popover" data-trigger="hover"
                                           ...
                                           data-original-title="Optional" data-placement="top" name="txt_space_price" id="txt_space_price" value="<?php echo $data[0]['sp_price'];?>"/>
                                </div>
                            </div>
                             <div class="form-group">
                                ...
                                <div class="col-sm-9 col-lg-10 controls">
                                    <input type="text" class="form-control show-popover" data-trigger="hover"
                                           ...
                                           data-original-title="Optional" data-placement="top" name="txt_space_size" id="txt_space_size" value="<?php echo $data[0]['sp_size'];?>"/>
                                </div>
                            </div>
                             <div class="form-group">
                                ...
                                <div class="col-sm-9 col-lg-10 controls">
                                    <input type="text" class="form-control show-popover" data-trigger="hover"
                                           ...
                                           data-original-title="Optional" data-placement="top" name="txt_space_add" id="txt_space_add" value="<?php echo $data[0]['sp_address'];?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-lg-10 controls">
                                    <input type="text" class="form-control show-popover" data-trigger="hover"
                                           data-content="Enter Location"
                                           data-original-title="Optional" data-placement="top" name="txt_space_loc" id="txt_space_loc" value="<?php echo $data[0]['loc'];?>"/>
                                </div>
                            </div><br />
 <div class="form-group">
                                <label class="col-sm-3 col-lg-2 control-label">Tax Size</label>

                                <div class="col-sm-9 col-lg-10 controls">
                                    <input type="text" class="form-control show-popover" data-trigger="hover"
                                           data-content="Enter Tax Size"
                                           data-original-title="Optional" data-placement="top" name="txt_tax_size" id="txt_tax_size" value="<?php echo $data[0]['tax_size'];?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-lg-10 controls">
                                    <input type="text" class="form-control show-popover" data-trigger="hover"
                                           ...
                                           data-original-title="Optional" data-placement="top" name="txt_space_rental_start" id="datepicker22"/>&nbsp;Prev : <?php echo $data[0]['sp_start'];?>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-lg-10 controls">
                                    <input type="text" class="form-control show-popover" data-trigger="hover"
                                           ...
                                           data-original-title="Optional" data-placement="top" name="txt_space_rental_end" id="datepicker33"/>&nbsp;Prev : <?php echo $data[0]['sp_ends'];?>
                                </div>
                            </div>
                             <div class="form-group">
                                ...
                                <div class="col-sm-9 col-lg-10 controls">
                                    <input type="text" class="form-control show-popover" data-trigger="hover"
                                           data-content="Enter Space Price"
                                           data-original-title="Optional" data-placement="top" name="txt_space_tax" id="txt_space_tax" value="<?php echo $data[0]['sp_tax'];?>"/>
                                </div>
                            </div>
                             <div class="form-group">
                                ...
                                <div class="col-sm-9 col-lg-10 controls">
                                    <input type="text" class="form-control show-popover" data-trigger="hover"
                                           ...
                                           data-original-title="Optional" data-placement="top" name="txt_space_elec" id="txt_space_elec" value="<?php echo $data[0]['sp_elec'];?>"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9 col-lg-10 controls">
                                    <input type="text" class="form-control show-popover" data-trigger="hover"
                                           ...
                                           data-original-title="Optional" data-placement="top" name="txt_space_misc" id="txt_space_misc" value="<?php echo $data[0]['sp_misc'];?>"/>
                                </div>
                            </div>
                             <div class="form-group">
                                ...
                                <div class="col-sm-9 col-lg-10 controls">
                                    <input type="text" class="form-control show-popover" data-trigger="hover"
                                           ...
                                           data-original-title="Optional" data-placement="top" name="txt_misc_remarks" id="txt_misc_remarks" value="<?php echo $data[0]['sp_remarks'];?>"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
                                    ...
                                    <a href="<?php echo base_url();?>index.php/view/Landlords" class="btn">View LandLord Details</a>
                                </div>
                            </div>
