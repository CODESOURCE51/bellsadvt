                    ...
                    <div class="box-content">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                             ...
                             <!--<div class="form-group">
                                <label class="col-sm-3 col-lg-2 control-label">Select Number of Area</label>

                                <div class="col-sm-9 col-lg-10 controls">
                                 <select class="form-control show-popover" data-placeholder="Choose a Category" tabindex="1"  data-trigger="hover"
                                           data-content="Enter Main Media Name"
                                           data-original-title="Mandatory ***" data-placement="top" name="txt_media_bill" id="txt_media_bill" onChange="return getSection();">		
                                            <option value="">Select...</option>
