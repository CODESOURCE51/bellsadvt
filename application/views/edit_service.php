<?php include_once('templates/header.php');?>
    ...
    <div id="main-content">
        ...
        <div class="page-title">
            <div>
                <h1><i class="fa fa-file-o"></i> Update Media</h1>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <div class="box-title">
                        <h3><i class="fa fa-bars"></i> Media Update Panel</h3>
                    ...
                    <div class="box-content">
                        <form name="service_form" action="<?php echo base_url();?>index.php/Update/Service" method="post" enctype="multipart/form-data" class="form-horizontal" onsubmit="return validate_service();">
                        <input type="hidden" name="cid" value="<?php echo $data[0]['service_id'];?>" />
                            <div class="form-group">
                                <label class="col-sm-3 col-lg-2 control-label">Media Name</label>
                            ...
                            <div class="form-group">
                                <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
                                    ...
                                    <a href="<?php echo base_url();?>index.php/view/Service" class="btn">View Media</a>
                                </div>
                            </div>
                        </form>
                    </div>
