<?php include_once('templates/header.php');?>
    ...
    <div id="main-content">
        ...
        <div class="page-title">
            <div>
                <h1><i class="fa fa-file-o"></i> View Signal / Order From</h1>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <div class="box-title">
                        <h3><i class="fa fa-bars"></i> Signal / Order From View Panel</h3>
                    ...
                    <div class="box-content">
                        <form name="service_form" action="<?php echo base_url();?>index.php/View/signal_order" method="post" enctype="multipart/form-data" class="form-horizontal"> 			                         <div class="form-group">
                                ...
                                <div class="col-sm-9 col-lg-10 controls">
                                 <select class="form-control show-popover" data-placeholder="Choose a Category" tabindex="1"  data-trigger="hover"
                                           ...
                                           data-original-title="Mandatory ***" data-placement="top" name="txt_type" id="txt_type" >
                                       
                                        <option value="">Select...</option>
                                       
                                        <option value="Hording">Hording </option>
                                        <option value="Signal">Signal </option>
                                        <option value="pole">Pole Kiosk </option>
                                        
                                    </select>
                                </div>
                            </div>      
                        <div class="form-group">
                                <label class="col-sm-3 col-lg-2 control-label">Select Name</label>
                                ...
                                <div class="col-sm-9 col-lg-10 controls">
                                 <select class="form-control show-popover" data-placeholder="Choose a Category" tabindex="1"  data-trigger="hover"
                                        ...
                                        <option value="<?php echo $main_areas['od_from'];?>"><?php echo $main_areas['od_from'];?> </option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
